...
@implementation BZWhiteVIPCancelVC
- (void)viewDidLoad {
    [super viewDidLoad];
    [self baseUIConfig];
...
{
    if(!_topView){
        _topView = [[BZWhiteTopView alloc]initWithFrame:CGRectZero isCancelView:YES];
...
{
    if(!_bottomView){
        _bottomView = [[BZWhiteBottomView alloc]initWithFrame:CGRectZero isCancelView:YES];
