...
@interface BZHotCell()<UICollectionViewDelegate,UICollectionViewDataSource>
@property (nonatomic,strong) UICollectionView *collectionView;
@property (nonatomic,assign) BOOL isLocked;
@end

@implementation BZHotCell
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell shadowColor:[UIColor grayColor] opacity:0.5 offset:CGSizeMake(1, 1) radius:8];
...
{
    return CGSizeMake(kHOT_CELL_WHIDE, kHOT_CELL_HEIGHT);
}
